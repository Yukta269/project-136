...
def save():
    ...
    file_handler = open("C:/Users/heman/OneDrive/Desktop/python programme/project 136/PRO-C136-Project-Boilerplate-main/static/assets/datafiles/updated_product_dataset.csv", "a")
